...
namespace MajorPrjt.Web.Areas.DForum.Controllers
{
    ...
    public class TopicsController : Controller
    {
        ...
        //public async Task<IActionResult> Index()
        //{
        //    var model = await _context.Topics
        ...
        public async Task<IActionResult> Create([Bind("TopicId,Title,Description,IsAnswered,PostDateTime")] Topic topic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TopicId,Title,Description,IsAnswered,PostDateTime")] Topic topic)
        {
            if (id != topic.TopicId)
            {
                return NotFound();
